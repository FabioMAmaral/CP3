...
def gerar_senha(tamanho_min, tamanho_max, num_caracteres_especiais, num_numeros, num_maiusculas):
    ...
    # Garante que a senha tenha pelo menos a quantidade desejada de caracteres especiais, números e letras maiúsculas
